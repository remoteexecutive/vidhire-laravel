                        ...
                        <div>
                            <div class="resume-pic-container">
                                <div class="space"></div>
                                    ...
                                    <img width="150" height="150" src="" alt="Resume Photo">

                            </div>
                            <div class="space"></div>
                            <ul>
                                <li>
                                    Minimum Hourly Rate: <strong></strong> 
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <ul>
                                <li> 
                                    ...
                                    &nbsp;
                                    <strong>
                                        <a href="mailto:test@emial.com?subject=Your Resume on VidHire"></a>
                                    </strong>
                                </li>
                                <li ><i class="fa fa-phone"></i>&nbsp;<strong></strong></li>
                                <li ><i class="fa fa-mobile"></i>&nbsp;<strong></strong></li>
                                <li ><i class="fa fa-skype"></i>&nbsp;<a href="skype"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="location">
                        ...
                        <div class="su-box-content su-clearfix">                                    
                            <div id="geolocation_box">
                                <p>
                                    <input type="hidden" class="hidden" name="jr_address" id="geolocation-address" value="">
